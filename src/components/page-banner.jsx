function PageBanner() {
  return (
    <section className=" bg-slate-100 py-12">
      <div className=" max-w-7xl m-auto md:h-[80vh] h-[60vh] rounded-2xl flex items-center justify-center bg-[url('src/assets/images/nawtechservices-herojpg.jpg')] bg-center bg-cover mx-6">
        <div className="w-full h-full bg-black rounded-2xl bg-opacity-60 flex items-center justify-center flex-col gap-6">
            <h1 className="text-5xl font-bold text-slate-50 ">Nos Services</h1>
