...
function Warranty() {
  return (
    <section className="bg-slate-100 py-24">
      <div className="m-auto max-w-7xl md:flex-row flex flex-col-reverse items-center justify-center gap-14 ">
        ...
        <div className="py-6 mx-3">
          <h3 className="text-4xl font-bold md:text-left text-center">Acheter en toute securité</h3>
