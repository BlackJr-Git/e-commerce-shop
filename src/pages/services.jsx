...
function ServiceSection({ flexType, ServiceTitle, description, image }) {
  return (
    <section className="bg-slate-100 py-24">
      <div
        className={` ${flexType} max-w-7xl m-auto flex flex-row items-center justify-center flex-wrap `}
      >
