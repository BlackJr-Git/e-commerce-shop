    ...
    <main className="bg-slate-100">
      <div className="max-w-6xl m-auto">
        ...
        <div className="flex items-center justify-center">
          <div className="border-2 border-slate-600  w-3/5 p-6">
          ...
          <div className="border-2 border-slate-600 w-2/5">
            <div className="max-w-6xl m-auto p-7 mb-6">
